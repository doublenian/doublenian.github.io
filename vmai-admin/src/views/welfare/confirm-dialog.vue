<template>
  <el-dialog title="添加公益" :visible.sync="dialogVisible" width="50%">
    <el-form :model="form" label-position="right" :rules="rules" label-width="120px" ref="ruleForm">
      <el-row :gutter="20">
        ...
        <el-col :span="24">
          <el-form-item label="请输入链接" prop="linker">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        linker: [{ required: true, message: '请输入链接', trigger: 'blur' }]
      },
      cloneData: {}
    }
  },
