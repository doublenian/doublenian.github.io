<template>
  <div class=" w-full px-10 mt-12">
    <el-button type="primary" class=" mb-5" @click="addBanner">添加新闻</el-button>
    <el-table :data="list" border>
      <el-table-column prop="title.zh" label="标题"></el-table-column>
      <el-table-column prop="title.en" label="英文标题"></el-table-column>
      <el-table-column prop="content.zh" label="内容"></el-table-column>
      <el-table-column prop="content.en" label="英文内容"></el-table-column>
