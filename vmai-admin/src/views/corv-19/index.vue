<template>
  <div class=" w-full px-10 mt-12">
    <el-button type="primary" class=" mb-5" @click="addBanner">添加抗疫活动</el-button>
    <el-table :data="list" border>
      <el-table-column prop="title.zh" label="抗疫活动标题"></el-table-column>
      <el-table-column prop="title.en" label="抗疫活动英文标题"></el-table-column>
